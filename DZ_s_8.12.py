print("Задача 1: Подсчет символов")
...
print("Задача 2: Проверка начала и конца")
...
print("Задача 3: Поиск первого вхождения")
...
print("Задача 7: Проверка и исправление email-адреса")
